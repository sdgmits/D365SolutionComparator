...
public class BusinessRuleComparer : IComparer<BusinessRuleDefinition>
{
    public ComparisonResult Compare(BusinessRuleDefinition? source, BusinessRuleDefinition? target)
    {
